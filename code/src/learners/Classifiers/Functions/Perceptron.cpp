...
void Perceptron::train(const Instance& instance) {
    ...
    #pragma acc enter data create(instance)
    ...
    /*#pragma acc enter data create(value)
    ...
    for (int i = 0; i < numberClasses; i++) {
        ...
        #pragma acc enter data create(weightMultiplier, instanceMultiplier)
...
double* Perceptron::getPrediction(const Instance& instance) {
    ...
    #pragma acc enter data create(actualClass, value)
